...
const AboutSpecialistDiv: FC<Props> = ({
  ...
  return (
    <main>
      <section
        className={`${className} lg:h-80 flex flex-col lg:flex-row gap-6  border-b md:w-[95%] border-midBlue border-opacity-50 bg-lightBlue p-5 lg:p-5 rounded-md lg:rounded-none`}
      >
        <img src={image} className="w-[18rem] h-[18rem]" alt='' />
