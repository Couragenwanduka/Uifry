  ...
  return (
    <main className="font-sans w-full overflow-hidden h-full">
      ...
      <section className="flex md:flex-row flex-col lg:w-[95%] justify-center md:pl-10 p-5 mt-32 md:mt-0">
        <article>
          <div>
            <h1 className="text-darkBlue md:text-5xl text-4xl font-sans font-bold">
          ...
          <div className="flex mt-5 gap-5 font-sans  items-center">
            <button className="bg-midBlue h-10 text-sm md:w-44 w-40 rounded-md font-semibold text-white">
              Book an appointment
            </button>
            <div className="flex gap-4 justify-center items-center">
              <img
                src="/icons/phone.svg"
                alt="Phone"
                className="h-10 border border-skyBlue p-2 rounded-md"
              />
              <span className="">
                <p className="text-midBlue md:text-sm text-xs font-semibold">
      ...
      <section className="flex flex-col md:flex-row md:w-[95%] h-full lg:ml-8 md:ml-4  lg:p-20 mt-20 p-5">
        <div>
          <Headertext
          ...
          <div className="flex items-center">
            ...
            <button className="bg-midBlue h-12 w-28 rounded-r-md mt-8">
              submit
            </button>
          </div>
        </div>
      ...
      <section className="flex flex-col-reverse lg:flex-row justify-between lg:p-32 bg-lightBlue lg:w-[95%] w-full lg:ml-8 mt-6 md:mt-7 lg:mt-0 p-5">
        ...
        <div className="lg:w-[60%] lg:ml-10">
          <Headertext
            ...
            content="Why choose Smile for all your dental treatments?"
          />
          <BodyText
            className="break-words lg:w-9/12 mt-5"
          ...
          <button className="bg-midBlue w-52 h-10 mt-5 rounded-md mb-5 lg:mb-0 ">
            Book an appointment
          </button>
        </div>
      </section>
      ...
      <section className="flex flex-col lg:flex-row md:w-[95%] h-full  lg:ml-10 md:ml-4 mt-10 md:mt-0 lg:p-14 p-5">
        <div className=" flex flex-col gap-">
          <Headertext
            className="break-words md:w-11/12 w-full  md:text-left text-pretty"
            content="Leave your worries at the door and enjoy a healthier, more precise smile"
          />
          <BodyText
            className="break-words md:w-9/12 w-full mt-4  md:text-left text-pretty"
          ...
          />
          <button className="bg-midBlue w-52 h-10 mt-5 rounded-md ">
            Book an appointment
          </button>
        </div>
      ...
      <section className="flex flex-col justify-center items-center mt-10 p-5 md:p-0">
